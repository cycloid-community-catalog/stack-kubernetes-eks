...
module "eks" {
  ...
  eks_managed_node_groups = {
    # all available options to configure cluster here https://github.com/terraform-aws-modules/terraform-aws-eks/blob/master/node_groups.tf#L263
    "k8s-${var.env}-green" = {
      ...
      #   apiVersion: node.cluster.x-k8s.io/v1beta1
      #   kind: NodeConfig
      #   kubelet:
      #     maxPods: 110
      #   EOF
...
# https://github.com/terraform-aws-modules/terraform-aws-vpc/tree/master/docs
